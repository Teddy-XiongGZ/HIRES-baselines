...
class SentenceAttr:
    def __init__(self,attr_list):
        self.article_id = attr_list[0]
        self.title = attr_list[1]
        self.sentence = attr_list[2]
        self.article_structure = attr_list[3]
        self.place = attr_list[4]
...
def test():
    sentences_path = "../src/sent_10000.txt"
